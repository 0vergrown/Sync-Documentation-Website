...
| [Attach Rope](./attach_rope.md)                             | Attaches a physics-simulated rope from the player to a block   |
| [Attach Rope Entity](./attach_rope_entity.md)               | Attaches a physics-simulated rope from the player to an entity |
| [Change Selected Slot](./change_selected_slot.md)           | Changes the player's currently selected hotbar slot            |
| [Change Slot](./change_slot.md)                             | Swaps or moves items between two inventory slots               |
